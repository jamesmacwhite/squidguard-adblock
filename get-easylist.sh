...
## Description: Gets Adblock lists and converts them to SquidGuard expression lists
## Version: 0.2
##
## Notes:
...
echo "SquidGuard Bin Path ${SQUIDGUARD_BIN}"
...
show_message "Preparing expression lists for SquidGuard"
